...
function App() {
  ...
  // Flow và hiểu: Tránh chạy lại hàm filterExpenses (vốn có delay 150ms) và tính tổng tiền khi component re-render
  // vì các state khác thay đổi mà query/expenses không đổi.
